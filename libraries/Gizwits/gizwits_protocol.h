...
* @{
*/
#define PRODUCT_KEY "5fedafcb9ebc4c7b89d06a70cb8a7855"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "ca85bebd885745e284a65df5d28a4414"
...
#define message_test_RATIO                         1
#define message_test_ADDITION                      0
#define message_test_MIN                           0
#define message_test_MAX                           255
#define T_test_RATIO                         1
#define T_test_ADDITION                      0
#define T_test_MIN                           0
#define T_test_MAX                           100
#define H_test_RATIO                         1
#define H_test_ADDITION                      0
#define H_test_MIN                           0
#define H_test_MAX                           100
/**@} */
...
typedef struct {
  bool valueon_off;
  uint32_t valuemessage_test;
  uint32_t valueT_test;
  uint32_t valueH_test;
} dataPoint_t;
