...
void Gizwits::read(EVENT_TYPE_T eventType, bool* value)
{
	...
	{
	      case EVENT_on_off:
	        *value = currentDataPoint.valueon_off;
	        break;
		default:
			break;
	}
...
void Gizwits::read(EVENT_TYPE_T eventType, uint32_t* value)
{
	switch(eventType)
	{
	      case EVENT_message_test:
	        *value = currentDataPoint.valuemessage_test;
	        break;
		default:
			break;
	}
...
bool Gizwits::hasBeenSet(EVENT_TYPE_T eventType)
{
	...
	{
			case EVENT_on_off:
				flag = 	attrFlags.flagon_off;
				attrFlags.flagon_off = 0;
				break;
			case EVENT_message_test:
				flag = 	attrFlags.flagmessage_test;
				attrFlags.flagmessage_test = 0;
				break;
		default:
			break;
	}
...
void Gizwits::write(VALUE_TYPE_T valueType, uint32_t value)
{
	...
	{
		case VALUE_T_test:
			currentDataPoint.valueT_test = value;
		break;
		case VALUE_H_test:
			currentDataPoint.valueH_test = value;
		break;
		default:
			break;
	}
